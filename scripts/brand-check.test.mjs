...
// The doc-pinning tests below read the sandbox's own prose, which a public
// clone does not carry — see scripts/sandbox-fixture.mjs.
const SKILL_DOC = [SANDBOX_FILES.ogSkill];
const SKILL_AND_AGENTS_DOCS = [SANDBOX_FILES.ogSkill, SANDBOX_FILES.agentsDoc];
...
test(
  ...
  { skip: sandboxSkip(TEMPLATE_ROOT, SKILL_AND_AGENTS_DOCS) },
  () => {
...
test(
  ...
  { skip: sandboxSkip(TEMPLATE_ROOT, SKILL_DOC) },
  () => {
